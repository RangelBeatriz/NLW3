...
module.exports = {
    ...
    async orphanage(request, response){
        ...
        try {
            ...
            console.log(error);
            return response.send('Erro no banco de dados ao criar orfanato');
    ...
    async orphanages(request, response) {
        try {
            ...
            console.log(error);
            return response.send("Erro no banco de dados consultar");
    ...
    async saveOrphanage(request, response){
        ...
        //valida se todos os estão preenchidos
